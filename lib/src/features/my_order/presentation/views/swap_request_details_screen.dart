          ...
          body: LayoutBuilderWidget(
            child: Column(
              children: [
                ...
                Text('Swap Requests Details',style: easyTheme.textTheme.headlineMedium!.copyWith(fontSize: 22.0.sp),),
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 13.0.h,),
                      Padding(
                        padding: EdgeInsetsDirectional.only(start: 22.0.w,end: 14.0.w,bottom: 20.0.h),
                        child: Text(
