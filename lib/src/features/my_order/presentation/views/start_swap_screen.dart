      ...
      child: SafeArea(
        child: Scaffold(
          ...
          body: CustomScrollView(
            slivers:[
              const SliverToBoxAdapter(child: HeaderWidget(withArrowBack: true,isLight: true),),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Assets.svg.locationPinIcon.svg(color: ColorName.amber,height: 22.0,width: 15.0.w),
              ...
              const SliverToBoxAdapter(child: SizedBox(height: 8.0,),),
                SliverToBoxAdapter(child: Text.rich(
                ...
                child: CarouselSlider(
                  ...
                  items: [1,2,3,4,5].map((i) {
                    return Padding(
                      ...
                      child: Container(
                        margin: const EdgeInsetsDirectional.only(end: 20.0,bottom: 20.0),
                        decoration: BoxDecoration(
                            color: ColorName.white,
                        ...
                        child: Column(
                          ...
                          children: [
                            Row(
                              children: [
                                Container(
                                  margin: EdgeInsetsDirectional.only(top: 3.0,start: 12.0.w),
                                ...
                                Expanded(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        padding: EdgeInsetsDirectional.only(end: 13.0.w,top: 14.0),
                                        child: Align(
                                          alignment: AlignmentDirectional.centerEnd,
                                          child: TextButtonWidget(
                            ...
                            Padding(
                              padding: EdgeInsetsDirectional.only(start: 22.0.w,end: 12.0.w,bottom: 17.0),
                              child: Text(
