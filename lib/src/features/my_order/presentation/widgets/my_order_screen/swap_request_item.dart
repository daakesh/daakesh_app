...
class WaitingSwapRequestItem extends StatelessWidget {
  const WaitingSwapRequestItem({super.key});
            ...
            child: Padding(
              ...
              child: Text.rich(TextSpan(children: [
                TextSpan(
                    ...
                    style:
                        easyTheme.textTheme.bodyMedium!.copyWith(fontSize: 14.0.sp)),
              ])),
            ),
          ),
            ...
            Expanded(
              child: DefaultButtonWidget(
                ...
                style: easyTheme.elevatedButtonTheme.style!.copyWith(
                  backgroundColor: MaterialStateProperty.all(ColorName.blueGray.withOpacity(0.5)),
            ...
            SizedBox(width: 9.0.w,),
              Expanded(
                child: DefaultButtonWidget(
                  ...
                  onPressed: () {},
                  style: easyTheme.elevatedButtonTheme.style!.copyWith(
                    backgroundColor: MaterialStateProperty.all(ColorName.amber.withOpacity(0.5)),
...
class AcceptedSwapRequestItem extends StatelessWidget {
  const AcceptedSwapRequestItem({super.key});
