...
class ComplaintBloc extends Bloc<ComplaintEvent, ComplaintState> {
  ...
  static ComplaintBloc get get => BlocProvider.of(navigatorKey.currentState!.context);

  FutureOr<void> _getAllComplaint(GetAllComplaintEvent event, Emitter<ComplaintState> emit) async{
  ...
  FutureOr<void> _addComplaint(AddComplaintEvent event, Emitter<ComplaintState> emit) async{
    emit(state.copyWith(complaintStateStatus:ComplaintStateStatus.LOADING));
    ...
    final result = await getIt.get<ProfileUseCases>().addComplaints(complaintType, sellerName, subject, remark);
    result.fold((l) {
      emit(state.copyWith(complaintStateStatus: ComplaintStateStatus.ERROR));
      ShowToastSnackBar.showSnackBars(message: l.message.toString());
    }, (r) async{
