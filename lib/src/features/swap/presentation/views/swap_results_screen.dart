...
class SwapResultsScreen extends StatelessWidget {
          ...
          body: CustomScrollView(
            slivers: [
              ...
              SliverList(
                ...
                (_, index) {
                  SwapSubCategory subCategoryItem =
                      state.swapSubCategoryListData[index];
                  return Padding(
                    padding: const EdgeInsets.symmetric(
                        vertical: 8.0, horizontal: 17),
                    child:
                        SwapResultItemWidget(swapSubCategory: subCategoryItem),
                  );
                },
  ...
  void getSubCategoriesData(int index) => SwapPassDataBloc.get
