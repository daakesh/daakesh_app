...
class SwapSearchFilterScreen extends StatelessWidget {
  SwapSearchFilterScreen({super.key});
                    ...
                    children: [
                      ...
                      BlocBuilder<SwapFilterBloc, SwapFilterState>(
                        ...
                        return DropDownButtonWidget<String>(
                          onChange: (value) {
                            SwapSearchBloc.get
                                .add(SwapSetSearchFilterDataEvent(city: value));
                          },
                          value: state.city,
  ...
  void apply(context) {
    SwapSearchBloc.get.add(SwapSearchFilterEvent(isFilterActive: true));
