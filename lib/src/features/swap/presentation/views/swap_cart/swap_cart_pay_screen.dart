...
class SwapCartPayScreen extends StatelessWidget {
  const SwapCartPayScreen({super.key});
      ...
      body: LayoutBuilderWidget(
        child: Column(
          children: [
            ...
            const SwapYourCartItemWidget(isWithEdit: false),
            const SizedBox(
              height: 14.0,
            ),
            const SwapShippingLocationWidget(isWithEdit: false),
            const SizedBox(
              height: 25.0,
            ),
            Padding(
