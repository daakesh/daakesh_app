...
class SwapAdvBloc extends Bloc<SwapAdvEvent, SwapAdvState> {
  ...
  static SwapAdvBloc get get => BlocProvider.of(navigatorKey.currentState!.context);

  FutureOr<void> _getAdvertisementData(SwapGetAdvertisementDataEvent event, Emitter<SwapAdvState> emit) async{
    ...
    result.fold((l) {
      ...
      emit(state.copyWith(swapAdvStateStatus: SwapAdvStateStatus.SUCCESS,swapAdvListData: swapAdvModel.data!.toList()));
    });
  }
