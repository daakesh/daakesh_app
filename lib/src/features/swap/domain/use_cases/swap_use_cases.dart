...
class SwapUseCasesImpl implements SwapUseCases {
  ...
  Future<Either<Failure, ValidResponse>> getCategoryBySectionID(int secID,int page) async {
    return await getIt.get<SwapRepository>().getCategoryBySectionID(secID,page);
  }
  @override
  ...
  Future<Either<Failure, ValidResponse>> addComment(int userId, int itemId, String commentDesc) async{
    return await getIt.get<SwapRepository>().addComment(userId,itemId,commentDesc);
  }
  @override
  ...
  Future<Either<Failure, ValidResponse>> addRate(int itemId, int userId, int catID, int rateValue) async{
    return await getIt.get<SwapRepository>().addRate(itemId,userId,catID,rateValue);
  }
  @override
