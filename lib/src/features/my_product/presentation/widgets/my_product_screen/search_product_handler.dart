...
class SearchProductHandler extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    switch (state.myProFuncStateStatus) {
      case MyProFuncStateStatus.LOADING:return const SliverToBoxAdapter(child: CircularProgressIndicatorWidget());
      case MyProFuncStateStatus.NULL:return const SliverToBoxAdapter(child: Center(child: Text('No information available...')));
