...
class SearchFilterScreen extends StatelessWidget {
            ...
            child: Column(
              ...
              children: [
                    ...
                    children: [
                      ...
                      BlocBuilder<FilterBloc, FilterState>(
                        ...
                        return DropDownButtonWidget<String>(
                          onChange: (value) {
                            SearchBloc.get
                                .add(SetSearchFilterDataEvent(city: value));
                          },
                          value: state.city,
                ...
                const Padding(
                  ...
                  child: SizedBox(
                      width: double.infinity, child: SearchProductTypeWidget()),
                ),
                const SizedBox(
                  height: 65.0,
                ),
  ...
  void apply(context) {
    SearchBloc.get.add(SearchFilterEvent(isFilterActive: true));
