...
class BrandFilterScreen extends StatelessWidget {
            ...
            child: Column(
              ...
              children: [
                    ...
                    children: [
                      ...
                      BlocBuilder<BrandsBloc, BrandsState>(
                        ...
                        return DropDownButtonWidget<String>(
                          onChange: (value) {
                            BrandsBloc.get.add(SetBrandFilterData(city: value));
                          },
                          value: state.city,
                      ...
                      const BrandPriceSlider(minValue: 0.0, maxValue: 1000.0),
                      BlocBuilder<BrandsBloc, BrandsState>(
                        builder: (context, state) {
                          return Row(
                            children: [
                ...
                const Padding(
                  ...
                  child: SizedBox(
                      width: double.infinity, child: BrandProductType()),
                ),
                const SizedBox(height: 14.0),
                Padding(
                  padding:
  ...
  void apply(context) {
    BrandsBloc.get.add(GetItemsByBrandsEvent(isFilterActive: true));
