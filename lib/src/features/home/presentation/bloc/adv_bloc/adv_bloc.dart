...
class AdvBloc extends Bloc<AdvEvent, AdvState> {
  ...
  static AdvBloc get get => BlocProvider.of(navigatorKey.currentState!.context);
  ///Event to get ADV data to display it into slider at [HomeDataWidget]
  FutureOr<void> _getAdvertisementData(GetAdvertisementDataEvent event, Emitter<AdvState> emit) async{
    ...
    result.fold((l) {
      ...
      emit(state.copyWith(advStateStatus: AdvStateStatus.SUCCESS,advListData: advModel.data!.toList()));
    });
  }
