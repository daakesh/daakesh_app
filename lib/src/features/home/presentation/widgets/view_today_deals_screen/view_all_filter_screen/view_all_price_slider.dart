...
class ViewAllTodayDealsPriceSlider extends StatefulWidget {
  ...
  @override
  State<ViewAllTodayDealsPriceSlider> createState() =>
      _PriceSliderWidgetState();
}

class _PriceSliderWidgetState extends State<ViewAllTodayDealsPriceSlider> {
  @override
  ...
  void setPrice(double fromPrice, double toPrice) => TodayDealsBloc.get
      .add(SetViewAllFilterEvent(fromPrice: fromPrice, toPrice: toPrice));
}
