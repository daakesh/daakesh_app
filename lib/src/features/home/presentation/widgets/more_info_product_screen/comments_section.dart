              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: Row(
                    children: [
                      CachedImage(
                        imageUrl: commentRateModelItem.user!.img != null ? commentRateModelItem.user!.img.toString() : '',
                        height: 40.0,
                        width: 40.0,
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                               Utils.calculate(commentRateModelItem.date.toString()),
                              style: context.easyTheme.textTheme.bodyMedium!
                                  .copyWith(
                                      fontSize: 11.0,
                      ...
                      RatingBar.builder(
                        ...
                        maxRating: 5,
                        ignoreGestures: true,
                        initialRating:  commentRateModelItem.item!.rate!.first.rateValue!.toDouble(),
                        itemSize: 15.0,
                        tapOnlyMode: true,
                      ...
                      Text(
                        commentRateModelItem.item!.rate!.first.rateValue!.toDouble().toString(),
