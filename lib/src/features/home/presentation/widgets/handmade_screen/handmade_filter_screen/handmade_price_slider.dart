...
class HandmadePriceSlider extends StatefulWidget {
  ...
  @override
  State<HandmadePriceSlider> createState() => _PriceSliderWidgetState();
}

class _PriceSliderWidgetState extends State<HandmadePriceSlider> {
  @override
  Widget build(BuildContext context) {
    return SliderTheme(
      ...
      child: BlocBuilder<HandmadeBloc, HandmadeState>(
  ...
  void setPrice(double fromPrice, double toPrice) => HandmadeBloc.get
      .add(SetHandmadeFilterDataEvent(fromPrice: fromPrice, toPrice: toPrice));
}
